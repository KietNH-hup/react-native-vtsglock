...
public class ResetKeyboardPasswordSession extends Session {

  public ResetKeyboardPasswordSession(String keyJson, Callback callback) {
  ...
  @Override public void execute(ExtendedBluetoothDevice extendedBluetoothDevice) {
    getLockApi().resetKeyboardPassword(extendedBluetoothDevice, 0, getLockData().getLockVersion(),
