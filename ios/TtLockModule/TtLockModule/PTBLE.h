...
typedef NS_ENUM(NSInteger,BLECommand) {
    ...
    // ahmad
    BLECommandSetAdminKeyboardPassword,
    BLECommandUnlockByAdministrator,
    BLECommandResetKeyboardPassword,
    
    BLECommandGetAudioState,
    BLECommandSetAudioState,
    
    BLECommandAddPeriodKeyboardPassword,
    
    BLECommandDeleteOneKeyboardPassword,
};
...
- (void)addPeriodKeyboardPassword:(NSString *)pin startTimestamp:(double)startTimestamp endTimestamp:(double)endTimestamp key:(LockModel *)key completion:(BLECompletion)completion;
- (void)deleteOneKeyboardPassword:(NSString *)pin key:(LockModel *)key completion:(BLECompletion)completion;
